...
- (BOOL)applicationWithApplication:(UIApplication * _Nonnull)application didFinishLaunchingWithOptions:(NSDictionary * _Nullable)launchOptions SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC13Zippy_Contact14ViewController")
